...
public class Client extends Thread {
        ...
        while (true) {
            ...
            if (auth.equals("false")) {
                ...
                if (commandList[0].equals("help")) {
                    System.out.println("Available Command List: logout message broadcast whoelse whoelsesince block unblock");
                    continue;
                }
    ...
    public void run() {
        ...
        while (true) {
            ...
            try {
                System.out.println("Tear down the packet");
                ...
                if (receivedPacket.getAuth().equals("true") && auth.equals("false") && receivedPacket.getRequest().equals("login")) {
                    auth = "true";
                }
                ...
                System.err.println("Getting this error");
